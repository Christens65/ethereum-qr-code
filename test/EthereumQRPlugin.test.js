...
const validConfigDetails = {
  ...
  global.it('should generate simple encoded string with required addess', () => {
    ...
    expect(str).toBe('ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=15000000000000000000000&gas=4200');
  });
  ...
  global.it('should generate simple encoded string with allowed params', () => {
    ...
    expect(str).toBe('ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=15000000000000000000000&gas=4200&chainId=34');
  });

  global.it('should generate DataURI and return string', () => {
    return qr.toDataUrl(validCodeDetails, validConfigDetails).then((result) => {
      return expect(result.amount).toBe("ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=15000000000000000000000&gas=4200");
  })
});
...
global.it('should generate DataURI string with correct symbols', () => qr.toDataUrl(validCodeDetails, validConfigDetails).then((result) => {
  ...
  global.it('should parse endcoded string to JSON', () => {
    ...
    const str = 'ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=15000000000000000000000&gas=4200000';
    ...
    const str2 = 'ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?from=0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8&amount=36453764&gas=33000';
    ...
    const str3 = 'ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?from=0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8&amount=7800000';
    ...
    const str4 = 'ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=1200000';
    ...
    const str5 = 'ethereum:0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8?amount=1200000&chainId=34';
